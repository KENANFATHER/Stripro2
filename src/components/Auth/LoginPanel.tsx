    ...
    >
      ...
      >
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl border border-white/30 shadow-2xl overflow-hidden">
          ...
          <div className="relative p-4 sm:p-6 border-b border-sage-200/50">
            <h2 
              id="login-panel-title" 
              className="text-xl sm:text-2xl font-bold text-sage-900 text-center pr-8"
            >
              Welcome to Stripro
            </h2>
            ...
            <p 
              ...
              className="text-sage-600 text-sm sm:text-base text-center mt-1"
            >
